...
MOD_INIT_DECL( six );
MOD_INIT_DECL( soupsieve );
MOD_INIT_DECL( soupsieve$__meta__ );
MOD_INIT_DECL( soupsieve$css_match );
MOD_INIT_DECL( soupsieve$css_parser );
MOD_INIT_DECL( soupsieve$css_types );
MOD_INIT_DECL( soupsieve$util );
...
{
    { "OpenSSL", MOD_INIT_NAME( OpenSSL ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "OpenSSL.SSL", MOD_INIT_NAME( OpenSSL$SSL ), 0, 0, NUITKA_COMPILED_MODULE },
    { "OpenSSL._util", MOD_INIT_NAME( OpenSSL$_util ), 0, 0, NUITKA_COMPILED_MODULE },
    { "OpenSSL.crypto", MOD_INIT_NAME( OpenSSL$crypto ), 0, 0, NUITKA_COMPILED_MODULE },
    { "OpenSSL.version", MOD_INIT_NAME( OpenSSL$version ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "backports.functools_lru_cache", MOD_INIT_NAME( backports$functools_lru_cache ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "cryptography.hazmat._oid", MOD_INIT_NAME( cryptography$hazmat$_oid ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "cryptography.hazmat.backends.openssl.ed25519", MOD_INIT_NAME( cryptography$hazmat$backends$openssl$ed25519 ), 0, 0, NUITKA_COMPILED_MODULE },
    { "cryptography.hazmat.backends.openssl.ed448", MOD_INIT_NAME( cryptography$hazmat$backends$openssl$ed448 ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "cryptography.hazmat.backends.openssl.ocsp", MOD_INIT_NAME( cryptography$hazmat$backends$openssl$ocsp ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "cryptography.hazmat.backends.openssl.x448", MOD_INIT_NAME( cryptography$hazmat$backends$openssl$x448 ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "cryptography.hazmat.primitives.asymmetric.ed25519", MOD_INIT_NAME( cryptography$hazmat$primitives$asymmetric$ed25519 ), 0, 0, NUITKA_COMPILED_MODULE },
    { "cryptography.hazmat.primitives.asymmetric.ed448", MOD_INIT_NAME( cryptography$hazmat$primitives$asymmetric$ed448 ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "cryptography.hazmat.primitives.asymmetric.x448", MOD_INIT_NAME( cryptography$hazmat$primitives$asymmetric$x448 ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "cryptography.hazmat.primitives.serialization", MOD_INIT_NAME( cryptography$hazmat$primitives$serialization ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "cryptography.hazmat.primitives.serialization.base", MOD_INIT_NAME( cryptography$hazmat$primitives$serialization$base ), 0, 0, NUITKA_COMPILED_MODULE },
    { "cryptography.hazmat.primitives.serialization.ssh", MOD_INIT_NAME( cryptography$hazmat$primitives$serialization$ssh ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "cryptography.x509.ocsp", MOD_INIT_NAME( cryptography$x509$ocsp ), 0, 0, NUITKA_COMPILED_MODULE },
    { "cryptography.x509.oid", MOD_INIT_NAME( cryptography$x509$oid ), 0, 0, NUITKA_COMPILED_MODULE },
    { "enum", MOD_INIT_NAME( enum ), 0, 0, NUITKA_PACKAGE_FLAG },
    ...
    { "ipaddress", MOD_INIT_NAME( ipaddress ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "simplejson", MOD_INIT_NAME( simplejson ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "simplejson.compat", MOD_INIT_NAME( simplejson$compat ), 0, 0, NUITKA_COMPILED_MODULE },
    { "simplejson.decoder", MOD_INIT_NAME( simplejson$decoder ), 0, 0, NUITKA_COMPILED_MODULE },
    { "simplejson.encoder", MOD_INIT_NAME( simplejson$encoder ), 0, 0, NUITKA_COMPILED_MODULE },
    { "simplejson.errors", MOD_INIT_NAME( simplejson$errors ), 0, 0, NUITKA_COMPILED_MODULE },
    { "simplejson.ordered_dict", MOD_INIT_NAME( simplejson$ordered_dict ), 0, 0, NUITKA_COMPILED_MODULE },
    { "simplejson.raw_json", MOD_INIT_NAME( simplejson$raw_json ), 0, 0, NUITKA_COMPILED_MODULE },
    { "simplejson.scanner", MOD_INIT_NAME( simplejson$scanner ), 0, 0, NUITKA_COMPILED_MODULE },
    { "six", MOD_INIT_NAME( six ), 0, 0, NUITKA_COMPILED_MODULE },
    { "soupsieve", MOD_INIT_NAME( soupsieve ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "soupsieve.__meta__", MOD_INIT_NAME( soupsieve$__meta__ ), 0, 0, NUITKA_COMPILED_MODULE },
    { "soupsieve.css_match", MOD_INIT_NAME( soupsieve$css_match ), 0, 0, NUITKA_COMPILED_MODULE },
    { "soupsieve.css_parser", MOD_INIT_NAME( soupsieve$css_parser ), 0, 0, NUITKA_COMPILED_MODULE },
    { "soupsieve.css_types", MOD_INIT_NAME( soupsieve$css_types ), 0, 0, NUITKA_COMPILED_MODULE },
    { "soupsieve.util", MOD_INIT_NAME( soupsieve$util ), 0, 0, NUITKA_COMPILED_MODULE },
