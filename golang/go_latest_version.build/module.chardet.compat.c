...
static PyObject *const_str_digest_f0aa0c313674b905ce326c88af674cda;
...
{
    const_str_digest_18672d344fa483c179ef434c8fedba1e = UNSTREAM_STRING( &constant_bin[ 247998 ], 14, 0 );
    const_str_plain_base_str = UNSTREAM_STRING( &constant_bin[ 248012 ], 8, 1 );
    const_str_digest_f0aa0c313674b905ce326c88af674cda = UNSTREAM_STRING( &constant_bin[ 248020 ], 50, 0 );
    const_str_digest_58e9489883b2042138fb899ca75ed20c = UNSTREAM_STRING( &constant_bin[ 248070 ], 23, 0 );
...
static PyCodeObject *codeobj_c630fa2471247d98d14a512d673961e6;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_f0aa0c313674b905ce326c88af674cda;
    codeobj_c630fa2471247d98d14a512d673961e6 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_58e9489883b2042138fb899ca75ed20c, 1, const_tuple_empty, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_c630fa2471247d98d14a512d673961e6;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_f0aa0c313674b905ce326c88af674cda;
    ...
    // Frame without reuse.
    frame_c630fa2471247d98d14a512d673961e6 = MAKE_MODULE_FRAME( codeobj_c630fa2471247d98d14a512d673961e6, module_chardet$compat );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_c630fa2471247d98d14a512d673961e6 );
    assert( Py_REFCNT( frame_c630fa2471247d98d14a512d673961e6 ) == 2 );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_c630fa2471247d98d14a512d673961e6 );
#endif
    popFrameStack();

    assertFrameObject( frame_c630fa2471247d98d14a512d673961e6 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_c630fa2471247d98d14a512d673961e6, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_c630fa2471247d98d14a512d673961e6->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_c630fa2471247d98d14a512d673961e6, exception_lineno );
    }
