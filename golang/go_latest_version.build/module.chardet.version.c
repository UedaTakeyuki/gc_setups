...
static PyObject *const_str_digest_3922043577b8f9acf37c4a98f473685e;
...
{
    const_str_digest_96baa068c2199be2cd71dcff3a585dfa = UNSTREAM_STRING( &constant_bin[ 526928 ], 24, 0 );
    const_str_digest_5f28c8ec13a43e2288b9f6b9b20df422 = UNSTREAM_STRING( &constant_bin[ 165734 ], 5, 0 );
    const_str_digest_3922043577b8f9acf37c4a98f473685e = UNSTREAM_STRING( &constant_bin[ 526952 ], 51, 0 );
    const_str_digest_273bc0eb91233c9ce50bbc2a025b5f82 = UNSTREAM_STRING( &constant_bin[ 527003 ], 179, 0 );
    const_str_digest_014d7364d9b7728f9db9c7c9e73a5813 = UNSTREAM_STRING( &constant_bin[ 526936 ], 15, 0 );
...
static PyCodeObject *codeobj_61081027e043f23bcee561b2e59e5477;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_3922043577b8f9acf37c4a98f473685e;
    codeobj_61081027e043f23bcee561b2e59e5477 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_96baa068c2199be2cd71dcff3a585dfa, 1, const_tuple_empty, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_61081027e043f23bcee561b2e59e5477;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_3922043577b8f9acf37c4a98f473685e;
    ...
    // Frame without reuse.
    frame_61081027e043f23bcee561b2e59e5477 = MAKE_MODULE_FRAME( codeobj_61081027e043f23bcee561b2e59e5477, module_chardet$version );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_61081027e043f23bcee561b2e59e5477 );
    assert( Py_REFCNT( frame_61081027e043f23bcee561b2e59e5477 ) == 2 );
    ...
    // Framed code:
    {
        ...
        frame_61081027e043f23bcee561b2e59e5477->m_frame.f_lineno = 9;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_61081027e043f23bcee561b2e59e5477 );
#endif
    popFrameStack();

    assertFrameObject( frame_61081027e043f23bcee561b2e59e5477 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_61081027e043f23bcee561b2e59e5477, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_61081027e043f23bcee561b2e59e5477->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_61081027e043f23bcee561b2e59e5477, exception_lineno );
    }
...
#if 0 && 0
    {
        PyObject *path_value = GET_STRING_DICT_VALUE( moduledict_chardet$version, (Nuitka_StringObject *)const_str_plain___path__ );
