...
static PyObject *const_str_digest_3529d5a6a9a2ae91591bb589f69f7f34;
extern PyObject *const_str_plain___file__;
static PyObject *const_str_digest_1ef2be679c93a76690cf2c3c235de80c;
static PyObject *const_list_str_digest_1ef2be679c93a76690cf2c3c235de80c_list;
...
{
    const_str_digest_3529d5a6a9a2ae91591bb589f69f7f34 = UNSTREAM_STRING( &constant_bin[ 555307 ], 81, 0 );
    const_str_digest_1ef2be679c93a76690cf2c3c235de80c = UNSTREAM_STRING( &constant_bin[ 555307 ], 69, 0 );
    const_list_str_digest_1ef2be679c93a76690cf2c3c235de80c_list = PyList_New( 1 );
    PyList_SET_ITEM( const_list_str_digest_1ef2be679c93a76690cf2c3c235de80c_list, 0, const_str_digest_1ef2be679c93a76690cf2c3c235de80c ); Py_INCREF( const_str_digest_1ef2be679c93a76690cf2c3c235de80c );
    const_str_digest_7e628d76d5bb40493758304c7212ec63 = UNSTREAM_STRING( &constant_bin[ 555388 ], 45, 0 );
...
static PyCodeObject *codeobj_94dff4151eb3923fc7281db05a3f171b;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_3529d5a6a9a2ae91591bb589f69f7f34;
    codeobj_94dff4151eb3923fc7281db05a3f171b = MAKE_CODEOBJ( module_filename_obj, const_str_digest_7e628d76d5bb40493758304c7212ec63, 1, const_tuple_empty, 0, CO_NOFREE | CO_FUTURE_DIVISION | CO_FUTURE_ABSOLUTE_IMPORT | CO_FUTURE_PRINT_FUNCTION );
}
...
#if PYTHON_VERSION >= 300
    {
        int r = PyObject_SetItem( PyImport_GetModuleDict(), const_str_digest_87f50f766f0662099c6808139cda5c51, module_cryptography$hazmat$bindings$openssl );
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_94dff4151eb3923fc7281db05a3f171b;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_3529d5a6a9a2ae91591bb589f69f7f34;
    ...
    }
    {
        ...
        tmp_assign_source_3 = LIST_COPY( const_list_str_digest_1ef2be679c93a76690cf2c3c235de80c_list );
    ...
    // Frame without reuse.
    frame_94dff4151eb3923fc7281db05a3f171b = MAKE_MODULE_FRAME( codeobj_94dff4151eb3923fc7281db05a3f171b, module_cryptography$hazmat$bindings$openssl );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_94dff4151eb3923fc7281db05a3f171b );
    assert( Py_REFCNT( frame_94dff4151eb3923fc7281db05a3f171b ) == 2 );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_94dff4151eb3923fc7281db05a3f171b );
#endif
    popFrameStack();

    assertFrameObject( frame_94dff4151eb3923fc7281db05a3f171b );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_94dff4151eb3923fc7281db05a3f171b, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_94dff4151eb3923fc7281db05a3f171b->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_94dff4151eb3923fc7281db05a3f171b, exception_lineno );
    }
...
#if 1 && 0
    {
        PyObject *path_value = GET_STRING_DICT_VALUE( moduledict_cryptography$hazmat$bindings$openssl, (Nuitka_StringObject *)const_str_plain___path__ );
